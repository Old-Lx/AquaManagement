...
server {
    listen 80;
    server_name localhost;# Puedes poner tu-servidor.com www.tu-servidor.com o tu IP Pública si no tienes dominio

    # Directorio donde están los archivos del frontend compilado
    root /home/<usuario>/AquaManagement/Web/dist/; # este sólo es un ejemplo
    index index.html;
