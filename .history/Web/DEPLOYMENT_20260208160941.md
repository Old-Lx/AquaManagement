...
server {
    listen 80;
    server_name tu-servidor.com www.tu-servidor.com; # O pon tu IP Pública si no tienes dominio

    root /var/www/pump-system/html;
    index index.html;
    ...
    # Esto redirige las llamadas de http://tudominio.com/api/... a localhost:3000/...
    location /api/ {
        # La barra al final de 3000/ es importante, elimina el prefijo /api al pasarla al backend
        # Si tu backend espera recibir /api/rutas, quita la barra final.
